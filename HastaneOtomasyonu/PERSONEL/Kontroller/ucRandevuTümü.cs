...
{
    public partial class ucRandevuTümü : UserControl
    {
        public ucRandevuTümü()
        {
            InitializeComponent();
        }

        private void ucRandevuTümü_Load(object sender, EventArgs e)
        {
            HastaBL bl = new HastaBL();
            

            dataGridView1.DataSource = bl.RandevuBilgileriGetir();
